...
export class AudioService {
  ...
  public getOneAudio(options: IFindOneOptions<IAudio>): Observable<IAudio> {
    return this.electronService.invoke$(Channel.GET_AUDIO, options);
  }

  public deletePhoto(audio: IAudio): Observable<void> {
    return this.electronService.invoke$(Channel.DELETE_PHOTO, audio);
  }

  public deleteAllPhoto(audios?: IAudio[]): Observable<void> {
